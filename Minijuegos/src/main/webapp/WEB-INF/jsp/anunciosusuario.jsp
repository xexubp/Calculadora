...
<body>
	...
	<form class="form-inline my-2 my-lg-0" id="buscar" name="buscar" method="post" action="/buscar">
		<a href="addanuncio" style="color: #000000;"><i class="far fa-plus-square fa-3x"></i></a>	
			...
			<tbody>
				<c:forEach var="c" items="${listaUsuario}">
					<tr>
						...
						<td><a href="/eliminar?idanuncio=${c.getIdanuncio()}" style="color: #c0392b" ><i class="fas fa-times-circle fa-2x"></i></a></td>
						<td><a href="/modificar?idanuncio=${c.getIdanuncio()}" style="color: #c0392b" ><i class="fas fa-pen-square fa-2x"></i></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
